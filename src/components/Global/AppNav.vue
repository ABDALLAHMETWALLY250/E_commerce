<template>
  <div class="nav-bar">
    <v-app-bar color="blue " height="fit-content" absolute>
      <v-container fluid>
        <v-row style="align-items: center; justify-content: space-evenly">
          <!-- Logo -->
          <v-col
            lg="3"
            md="2"
          ...
          <!-- Logo -->
          <!-- Search-lg -->
          <v-col lg="5" md="6" class="lg-flex sm-none md-flex">
            <div class="position-relative sm-none" style="width: 90%">
              <input
                type="search"
                name="navSearch"
                id="navSearch"
          ...
          <!-- Search-lg -->
          <!-- cart & Available -->
          <v-col class="text-center sm-none" lg="4" md="4">
            <div
              class="parent text-white d-flex justify-space-between align-center"
            >
              <div class="avilable lg sm-none md-none">
              ...
              <div
                ...
                @click="$router.push('/wishlist-page')"
              >
                <v-badge
                  location="right top"
                  :content="getQuantitiesWishList"
                  color="red"
                  offset-x="-15"
                ></v-badge>
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
          ...
          <!-- Cart-small -->
          <v-col xs="6" sm="6" class="lg-none md-none">
            <div class="text-end w-100">
              <v-menu open-on-hover class="w-100">
                <template v-slot:activator="{ props }">
                  <v-btn v-bind="props">
                    <v-icon size="x-large"> mdi-dialpad </v-icon>
                  </v-btn>
                </template>

                <v-list class="bg-black w-100">
                  <v-list-item
                    class="text-center d-flex align-center justify-space-around w-100"
                  >
                    <div
                      class="wishlistes d-flex flex-column align-center"
                      @click="$router.push('/wishlist-page')"
        ...
        <v-row class="d-flex align-center justify-around">
          <!-- Links -->
          <v-col cols="8" class="md-none sm-none lg-flex">
            <ul class="links">
          ...
          <v-col cols="4" class="lg-none md-flex sm-flex">
            <div class="text-center">
              <v-menu open-on-hover>
                <template v-slot:activator="{ props }">
                  <v-btn size="x-large" v-bind="props"> Menu </v-btn>
                </template>
          ...
          <!-- Help & Lang -->
          <v-col lg="4" sm="8" xs="8" md="8" class="d-flex justify-end">
            ...
            >
              ...
              <span>{{ selectLang[0].lang }} / {{ selectLang[0].coin }}</span>
